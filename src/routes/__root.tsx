...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Localix Delivery" },
      { property: "og:description", content: "Delivery próprio, sem comissão de marketplaces. Cardápio digital e pedidos pelo WhatsApp." },
